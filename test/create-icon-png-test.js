...
describe('writeIconPNG', function() {
  ...
  it('IconPNGData should not be empty in user Object', function() {
    assert.isNotEmpty(result.IconPNGData, 'IconPNGData is not empty' )
    console.log('IconPNGData is not empty')
  })
